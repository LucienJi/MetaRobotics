...
from utils.torch_utils import quaternion_slerp
from AMP.dataset import pose3d
from AMP.dataset import motion_util
        ...
        for i, motion_file in enumerate(motion_files):
            ...
            with open(motion_file, "r") as f:
                ...
                self.trajectories.append(torch.tensor(
                    motion_data[
                        :,
                        AMPLoader.ROOT_ROT_END_IDX:AMPLoader.JOINT_VEL_END_IDX  #! 这里没有增加 最后的 data TAR_TOE_VEL_LOCAL_START_IDX,但是最后 feed data 的时候, 还是增加了 root state z
